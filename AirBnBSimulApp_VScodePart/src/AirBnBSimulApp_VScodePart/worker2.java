package AirBnBSimulApp_VScodePart; //worker with workerId=1!!
...
public class worker2 extends Thread { // server on the master and a client on the reducer
	...
	public static final int PORT = 2346; // 2346 and 2347 the other two

	public static void main(String[] args) {
		RoomNode workerRoomDB = new RoomNode();
		int workerId = 1;
		worker2 worker = new worker2(workerRoomDB, workerId);
		worker.start();
	}
	...
	public worker2(String workersHost, RoomNode workerRoomDB, int workerId) {
	...
	public worker2(RoomNode workerRoomDB, int workerId) {
		this.workersHost = workersHost;
		this.workerId = workerId;
		this.providerWorkerSocket = providerWorkerSocket;
		this.connectionMW = connectionMW;
