package AirBnBSimulApp_VScodePart; //worker with workerId=0!!
...
public class worker1 extends Thread { // server on the master and a client on the reducer
	...
	public static final int PORT = 2345; // 2346 and 2347 the other two

	public static void main(String[] args) {
		RoomNode workerRoomDB = new RoomNode();
		int workerId = 0;
		worker1 worker1 = new worker1(workerRoomDB, workerId);
		worker1.start();
	}
	...
	public worker1(String workersHost, RoomNode workerRoomDB, int workerId) {
	...
	public worker1(RoomNode workerRoomDB, int workerId) {
		this.workersHost = workersHost;
		this.workerId = workerId;
		this.providerWorkerSocket = providerWorkerSocket;
		this.connectionMW = connectionMW;
